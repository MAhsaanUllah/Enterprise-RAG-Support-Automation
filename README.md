...
├── assets/
│   └── agent_test_result.jpg      # UAT Success Screenshot
├── docs/
│   └── IndusPrecision_Technical_Manual_2026.docx  # Sample SOPs
└── README.md
```
...
1. Import the `industrial_sop_agent.json` into your n8n instance.
2. Configure Credentials for Google Docs API, Pinecone, and Google Gemini (PaLM) API.
3. Set the Pinecone mode to **Insert** for initial data loading, then switch to **Retrieve** for the Chat Agent.
